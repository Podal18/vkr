...
class Ui_EmployeeProfileWindow(object):
    def setupUi(self, EmployeeProfileWindow):
        ...
        self.name_value = QtWidgets.QLabel("Иванов Иван Иванович", self.tab_info)
        ...
        self.birth_value = QtWidgets.QLabel("01.01.1990", self.tab_info)
        ...
        self.profession_value = QtWidgets.QLabel("Электрик", self.tab_info)
        ...
        self.status_value = QtWidgets.QLabel("Активен", self.tab_info)
        ...
        self.violations_table.setHorizontalHeaderLabels(["Дата", "Описание"])
        self.violations_table.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)

        self.fade_animation(EmployeeProfileWindow)
