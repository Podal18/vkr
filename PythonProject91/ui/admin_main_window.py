...
class Ui_AdminMainWindow(object):
    def setupUi(self, AdminMainWindow, full_name="Администратор"):
        ...
        self.reset_btn = self.create_button(self.nav_panel, "Сброс пароля", 180)
        self.logs_btn = self.create_button(self.nav_panel, "Журнал действий", 235)
        ...
        self.fade_animation(AdminMainWindow)
