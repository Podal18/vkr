...
from ui.object_window import Ui_ObjectWindow
from ui.document_window import Ui_DocumentWindow
from ui.report_window import Ui_ReportWindow
...
class Ui_HRMainWindow(object):
    def setupUi(self, HRMainWindow, full_name="HR-специалист"):
        ...
        self.documents_btn = self.create_button(self.nav_panel, "Документы", 125)
        self.assignments_btn = self.create_button(self.nav_panel, "Назначения", 180)
        self.projects_btn = self.create_button(self.nav_panel, "Объекты", 235)
        self.reports_btn = self.create_button(self.nav_panel, "Отчёты", 290)
    ...
    def open_employees(self):
        from ui.employee_window import EmployeeWindow  # Импортируйте класс-обертку
